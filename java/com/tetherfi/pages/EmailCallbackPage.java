...
public class EmailCallbackPage extends BasePage {
    public EmailCallbackPage(WebDriver driver) {
        super(driver);
    }
    ...
    public boolean isEmailCallbackPageDisplayed() throws InterruptedException {
        waitForLoad(driver);
        waitForJqueryLoad(driver);
        return emailCallback.isEnabled();
    }
