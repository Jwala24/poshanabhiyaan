...
public class ModuleExitNodeMappingPage extends BasePage {

    public ModuleExitNodeMappingPage(WebDriver driver){super(driver);}
    ...
    public boolean isModuleExitNodeMappingPageDisplayed() {
        waitForLoad(driver);
        waitForJqueryLoad(driver);
        return moduleExitNodeMapping.isEnabled();
    }
