...
public class TPRedemptionPage extends BasePage {

    public TPRedemptionPage(WebDriver driver){super(driver);}
    ...
    public boolean isTPRedemptionPageDisplayed() {
        waitForLoad(driver);
        waitForJqueryLoad(driver);
        return tpRedemption.isEnabled();
    }
